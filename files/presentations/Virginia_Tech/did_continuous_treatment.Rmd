...
institute: ""
date: "September 22, 2023<br>Virginia Tech"
output:
...
<center><img src="tweet_better.png" width=90%></center>
...
However, there are <span class="alert">new issues</span> related to interpreting differences between treatment effects at different doses as <span class="alert">causal effects</span>
...
$\implies$ (at least in some sense), this is <mark>more negative than previous papers</mark>
...
# Baseline Case <br><br> Two periods, no one treated in first period
...
Strong parallel trends is also closely related to assuming a certain <span class="alert">form of treatment effect homogeneity</span>
